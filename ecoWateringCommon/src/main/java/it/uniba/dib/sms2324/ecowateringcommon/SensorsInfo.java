...
public class SensorsInfo implements Parcelable {
    public static final long IS_SENSOR_VALUE_VALID_TOLERANCE = 5; // minute
    public static final String BO_SENSORS_INFO_OBJ_NAME = "sensorsInfo";
    public static final String TABLE_SENSORS_INFO_AMBIENT_TEMPERATURE_SENSOR_COLUMN_NAME = "ambientTemperatureSensor";
    public static final String TABLE_SENSORS_INFO_AMBIENT_TEMPERATURE_LAST_UPDATE_COLUMN_NAME = "ambientTemperatureLastUpdate";
    public static final String TABLE_SENSORS_INFO_LIGHT_SENSOR_COLUMN_NAME = "lightSensor";
    public static final String TABLE_SENSORS_INFO_LIGHT_LAST_UPDATE_COLUMN_NAME = "lightLastUpdate";
    public static final String TABLE_SENSORS_INFO_RELATIVE_HUMIDITY_SENSOR_COLUMN_NAME = "relativeHumiditySensor";
