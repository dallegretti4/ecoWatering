...
public class WeatherInfo implements Parcelable {
    ...
    public static final String BO_WEATHER_INFO_AMBIENT_TEMPERATURE_COLUMN_NAME = "temperature_2m";
    public static final String BO_WEATHER_INFO_RELATIVE_HUMIDITY_COLUMN_NAME = "relative_humidity_2m";
    public static final String BO_WEATHER_INFO_WEATHER_CODE_COLUMN_NAME = "weather_code";
    public static final String BO_WEATHER_INFO_UV_INDEX_COLUMN_NAME = "uv_index";
    private String time;
    ...
    public static void updateWeatherInfo(@NonNull Context context) {
        new Thread(() -> {
            String jsonString = "{\"" + EcoWateringHub.TABLE_HUB_DEVICE_ID_COLUMN_NAME + "\":\"" + Common.getThisDeviceID(context) + "\",\"MODE\":\"UPDATE_WEATHER_INFO\"}";
