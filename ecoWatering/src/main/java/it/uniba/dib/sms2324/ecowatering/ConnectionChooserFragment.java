    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        bluetoothModeButton.setOnClickListener((v) -> {
            if(ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED &&
                ...
                ActivityCompat.requestPermissions(requireActivity(), new String[] {Manifest.permission.BLUETOOTH_CONNECT}, Common.FIRST_BT_CONNECT_PERMISSION_REQUEST);
            }
            else {
        ...
        wifiModeButton.setOnClickListener((v) -> {
            if(ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.NEARBY_WIFI_DEVICES) != PackageManager.PERMISSION_GRANTED &&
                ...
                ActivityCompat.requestPermissions(requireActivity(), new String[] {Manifest.permission.NEARBY_WIFI_DEVICES}, Common.FIRST_WIFI_PERMISSION_REQUEST);
            }
            else {
