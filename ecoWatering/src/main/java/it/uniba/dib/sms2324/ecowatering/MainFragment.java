...
import it.uniba.dib.sms2324.ecowateringcommon.EcoWateringHubAdapter;
import it.uniba.dib.sms2324.ecowateringcommon.EcoWateringHubComparator;

public class MainFragment extends Fragment {
    private static List<EcoWateringHub> ecoWateringHubList;
    private static ArrayAdapter<EcoWateringHub> ecoWateringHubAdapter;
    private OnMainFragmentActionCallback onMainFragmentActionCallback;
    protected interface OnMainFragmentActionCallback {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // FILL EWS LIST FROM CONFIGURATION CHANGE
        if(savedInstanceState != null && savedInstanceState.getParcelableArrayList(Common.BUNDLE_EWH_LIST_KEY) != null) {
            ArrayList<EcoWateringHub> helpEcoWateringHubList = savedInstanceState.getParcelableArrayList(Common.BUNDLE_EWH_LIST_KEY);
        ...
        // FILL EWS LIST FROM DATABASE SERVER
        else {
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(Common.BUNDLE_EWH_LIST_KEY, new ArrayList<>(ecoWateringHubList));
    }

    private void uploadEcoWateringHubList(@NonNull View view) {
        ArrayList<EcoWateringHub> hubListHelper = new ArrayList<>();
