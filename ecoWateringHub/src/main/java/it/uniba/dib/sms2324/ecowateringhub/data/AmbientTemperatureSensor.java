...
public class AmbientTemperatureSensor extends EcoWateringSensor {
    ...
    protected void updateSensorValueOnServerDb(@NonNull Context context) {
        ...
        new Thread(() -> {
            ...
            Log.i(Common.LOG_NORMAL, "updateSensorAmbTempValueOnServerDb response: " + response + " - value: " + this.currentValue);
        }).start();
    }
    ...
    protected Sensor recoverSensorFromSensorID(@NonNull Context context) {
        ...
        ArrayList<Sensor> deviceSensorsList = getConnectedSensorList(context, SensorsInfo.CONFIGURE_SENSOR_TYPE_AMBIENT_TEMPERATURE);
