...
public class IrrigationSystemStartingWorker extends Worker {
    private final Context context;

    public IrrigationSystemStartingWorker(@NonNull Context context, @NonNull WorkerParameters params) {
